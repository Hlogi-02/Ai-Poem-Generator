...
function generatePoem(event) {
  ...
  let context =
    "You are an expert in writing short heartfelt poems. Your mission is to generate 4 line poem in basic HTML and seperate each line with a <br />. Make sure to follow user instructions. Do not include a title to the poem. Sign the poem with 'Hlogi AI' inside a <strong> element at the end of the poem and NOT at the beginning";
  let prompt =
    "User instructions: Generate an english poem about  ${instructionsInput.value}";
